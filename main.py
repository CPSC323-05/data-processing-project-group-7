...
#patterns = [
#    (r'\d+|".*?"', 'LITERAL'),  # Literal
#    (r'\b(?:if|else|for|while|def|return|and|lamda|or|not|in|global|True|False|None|break|class|del|continue|is|not|import|yield)\b', 'KEYWORD'),  # Keyword
...
#|Category       |     Token                             |
#---------------------------------------------------------
#|Keywords       | def, return, if, print                |
#|Identifiers    | num1, num2, a, b, result, calulate_sum|
#|Operator       | +, =, ==                              |
#|Delimiters     | (,),:, ,                              |
#|Literal        | 10, 20, "__main__                     |
#---------------------------------------------------------
